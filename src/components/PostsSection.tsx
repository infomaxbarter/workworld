      ...
      <CardContent className="p-4 sm:p-6 space-y-4">
        ...
        {showForm && (
          <div className="space-y-3 p-3 border border-border rounded-lg bg-muted/30">
            <Input value={title} onChange={e => setTitle(e.target.value)} placeholder={t('posts.title_placeholder')} />
            <Textarea value={content} onChange={e => setContent(e.target.value)} placeholder={t('posts.content_placeholder')} rows={5} />
